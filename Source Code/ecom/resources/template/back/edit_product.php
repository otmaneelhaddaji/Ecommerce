...
if(isset($_GET['id'])){
  ...
  while($row = fetch_array($query)){
    ...
    $product_large_image        = escape_string($row['product_large_image']);
  }
}
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <aside id="admin_sidebar" class="col-md-4">
            ...
            <div class="form-group">
                ...
                <img width="60" src="<?php $product_image; ?>">
                <label for="product-title">Product Large Image</label>
                <input type="file" name="file">
                <img width="60" src="<?php $product_large_image; ?>">
